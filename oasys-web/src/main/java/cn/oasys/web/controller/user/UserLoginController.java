...
public class UserLoginController {
    ...
    public void getuserlog(int page, HttpSession session, Model model, String basekey, String time,
        ...
        List<AoaUserLog> page3=userService.ulogpaging(basekey, userid, time);
        PageInfo<AoaUserLog> aoaUserLogPageInfo=new PageInfo<>(page3);
        model.addAttribute("page", aoaUserLogPageInfo);
        model.addAttribute("userloglist", page3);
    ...
    public String test3df342(@RequestParam(value = "page", defaultValue = "0") int page,
        ...
        long userid = Long.valueOf(session.getAttribute("userId") + "");
        PageHelper.startPage(page, 15);
        List<AoaUserLoginRecord> aoaUserLoginRecords = userLoginRecordService.getAll(userid,basekey);
